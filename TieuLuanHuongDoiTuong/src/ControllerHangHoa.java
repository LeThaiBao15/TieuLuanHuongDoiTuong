    ...
    public HangHoa inputHangHoa(){
        ...
        switch (key) {
            case 1:
                ...
                hanghoa = new HangDienMay(maH,sLTHKK, tenHH, donGiaHH, thoiGianBH, congSuat);
                break;
            case 2:
                ...
                try {
                    ...
                    hanghoa = new HangThucPham(maH,sLTHKK, tenHH, donGiaHH, ngaySX, ngayHH, nhaCC);
            ...
            case 3:
                ...
                try {
                    ...
                    hanghoa = new HangSanhSu(maH, sLTHKK, tenHH, donGiaHH, nhaSX, ngayNhapKho);
                } catch (ParseException e) {
