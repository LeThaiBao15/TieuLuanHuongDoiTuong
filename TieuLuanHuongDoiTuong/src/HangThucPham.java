...
public class HangThucPham extends HangHoa{
    ...
    public HangThucPham(int maH,int sLTHKK, String tenHH, double donGiaHH, java.util.Date ngaySX2, java.util.Date ngayHH2, String nhaCC) {
        super(maH, sLTHKK, tenHH, donGiaHH);
        this.ngaySX = ngaySX2;
        this.ngayHH = ngayHH2;
        this.nhaCC = nhaCC;
    }
    public HangThucPham(Date ngaySX, Date ngayHH, String nhaCC) {
        this.ngaySX = ngaySX;
        this.ngayHH = ngayHH;
        this.nhaCC = nhaCC;
    }
    ...
    public String toString() {
        return super.toString() +"HangThucPham [ngayHH=" + ngayHH + ", ngaySX=" + ngaySX + ", nhaCC=" + nhaCC + "]";
    }
